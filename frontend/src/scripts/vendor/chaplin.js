    ...
    return Composer = (function() {
      ...
      Composer.prototype.compose = function(type, options) {
        ...
        if (arguments.length === 2 || typeof type === 'function') {
          ...
          options.compose = function() {
            return _this.perform(type, options);
          };
          options.check = function(composition) {
            return composition.type === type && _(composition.params).isEqual(options.params);
          };
        } else {
          options = type;
        }
        ...
        composition = _(this.compositions).find(options.check);
        if (composition != null) {
          return this.stale(composition, false);
        } else {
          return this.compositions.push(options.compose());
        }
      };
